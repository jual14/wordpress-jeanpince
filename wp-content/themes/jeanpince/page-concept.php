...
<?php get_template_part( 'under-nav-concept' ); ?>

<div class="block">
	<img src="<?php echo get_template_directory_uri(); ?>/assets/dist/img/notrehistoiretest.jpg" data-speed="-1" class="img-para-concept">
